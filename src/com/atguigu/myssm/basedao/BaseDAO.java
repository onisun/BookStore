...
public abstract class BaseDAO<T> {
    ...
    public BaseDAO() {
        ...
        try {
            ...
            e.printStackTrace();
            throw new DAOException("BaseDAO的构造方法出错了...");
        }
    }
    ...
    protected int executeUpdate(String sql, Object... params){
        ...
        try {
            ...
            e.printStackTrace();
            throw new DAOException("BaseDAO的executeUpdate方法出错了...");
        }
    ...
    private void setValue(Object obj, String property, Object propertyValue) {
        ...
        try {
            ...
            if (field != null) {
                ...
                //判断如果是自定义类型，则需要调用这个自定义类的带一个参数的构造方法，创建出这个自定义类的实例对象
            ...
            e.printStackTrace();
            throw new DAOException("BaseDAO的setValue方法出错了...");
    ...
    protected T load(String sql, Object... params){
        try {
            ...
            e.printStackTrace();
            throw new DAOException("BaseDAO的load方法出错了...");
        }
        return null;
    }
...
//                    String columnName = rsmd.getColumnName(i + 1);            //fid   fname   price
            ...
            e.printStackTrace();
            throw new DAOException("BaseDAO的executeQuery方法出错了...");
        }
        return list;
    }
}
